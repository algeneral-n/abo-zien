/**
 * RARE 4N - Awareness System (الأوير)
 * نظام الوعي - Location, Time, Device, Ambient Sensing
...
export class AwarenessSystem {
  ...
  async init(kernel: RAREKernel): Promise<void> {
    ...
    // ✅ لا نطلب الأذونات عند البدء - نطلبها عند الحاجة فقط
  ...
  private startUpdates(): void {
    // ✅ لا نبدأ التحديثات تلقائياً - فقط عند الطلب
